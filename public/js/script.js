...
$(document).ready(function() {
    ...
    function createMarker(latlng, label, html) {
        ...
        var timage = { url:'https://www.freeiconspng.com/uploads/truck-trailer-png-icon-5.png',
    ...
    service.getDistanceMatrix(
   {
    ...
    function callback(response, status) {
        ...
        if (status == 'OK') {
            ...
            for (var i = 0; i < origins.length; i++) {
              ...
              for (var j = 0; j < results.length; j++) {
                ...
                document.getElementById("speed").innerHTML = element.duration.text;
                document.getElementById("distancerem").innerHTML = element.distance.text;
                if(complete){
                    document.getElementById("speed").innerHTML = "0";
                document.getElementById("distancerem").innerHTML = "0";
               }
        ...
        updatePoly(index, d);
        timerHandle[index] = setTimeout(function(){animate(index , (d + step))}, tick || 100);
    ...
    function startAnimation(index) {
        ...
        timerHandle[index] = setTimeout(function(){animate( index ,50)}, 2000);  // Allow time for the initial map display
